  ...
  update: function(e) {
    ...
    var newState = {
      ...
      translate: [
        ...
        parseInt(form.querySelectorAll('.translate.' + c)[1].value, 10),
      ],
  ...
  render: function() {
    return (
      <form className="projectionController" onSubmit={this.update}>
        ...
        <input className='rotate slider n0' type='range' onChange={this.updateSlider} min="-180" max="180" step="0.1" value={this.props.rotate[0]} /> 
        <input className='rotate slider n1' type='range' onChange={this.updateSlider} min="-90" max="90" step="0.1" value={this.props.rotate[1]} /> 
        <input className='rotate slider n2' type='range' onChange={this.updateSlider} min="-180" max="180" step="0.1" value={this.props.rotate[2]} />
        <div className='rotateDisplayValue'>
          <span>(</span>
          <input className='rotate fi n0' type='number' step="0.1" defaultValue={this.props.rotate[0]} />
          <span>,</span>
          <input className='rotate fi n1' type='number' step="0.1" defaultValue={this.props.rotate[1]} />
          <span>,</span>
          <input className='rotate fi n2' type='number' step="0.1" defaultValue={this.props.rotate[2]} />
          <span>)</span>
        </div>
        <div className='txt'>Translate: </div>
        <input className='translate slider n0' type='range' onChange={this.updateSlider} min="-500" max="500" value={this.props.translate[0]} /> 
        <input className='translate slider n1' type='range' onChange={this.updateSlider} min="-500" max="500" value={this.props.translate[1]} /> 
        <div className='translateDisplayValue'>
          <span>(</span>
          <input className='translate fi n0' type='number' defaultValue={this.props.translate[0]} />
          <span>,</span>
          <input className='translate fi n1' type='number' defaultValue={this.props.translate[1]} />
          <span>)</span>
        </div>
        ...
        <input className='scaleRatio slider n0' type='range' onChange={this.updateSlider} min="0.0" max={this.props.maxScaleRatio} step="0.01" value={this.props.scaleRatio} />
        <div className='scaleRatioDisplayValue'>
          <input className='scaleRatio fi n0' type='number' min="0.0" step="0.01" defaultValue={this.props.scaleRatio} />
        </div>
