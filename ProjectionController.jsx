  ...
  render: function() {
    ...
    return (
      <form className="projectionController" onSubmit={this.update}>
        ...
        <select value={this.props.projectionType} className="projectionType n0" >
        ...
        <input className="center slider n0" type='range' onChange={this.updateSlider} min="-180" step="0.1" max="180" value={this.props.center[0]} />
        <input className='center slider n1' type='range' onChange={this.updateSlider} min="-90" step="0.1" max="90" value={this.props.center[1]} />
        <div className='centerDisplayValue'>
          <span>(</span>
          <input className="center fi n0" type='number' step="0.1" defaultValue={this.props.center[0]} />
          <span>,</span>
          <input className="center fi n1" type='number' step="0.1" defaultValue={this.props.center[1]} />
          <span>)</span>
        </div>
        ...
        <select value={this.props.showGridLines} className="showGridLines n0" >
          <option value={true}>Yes</option>
          <option value={false}>No</option>
        </select>
        <div className='txt'>Show continent labels?</div>
        <select value={this.props.showContinentLabels} className="showContinentLabels" >
          <option value={true}>Yes</option>
          <option value={false}>No</option>
        </select>
        <div className='txt'>Show ocean labels?</div>
        <select value={this.props.showOceanLabels} className="showOceanLabels" >
          <option value={true}>Yes</option>
          <option value={false}>No</option>
        </select>
        ...
        <div className="zoomToPathOptions">
          ...
          <select value={this.props.zoomDataset} className="zoomDataset" >
            {zoomDatasetOptions}
          </select>
